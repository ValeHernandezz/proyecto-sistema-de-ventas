...
public class MenuAdministrador extends JPanel {
	...
	private JLabel labelMenuAdministrador;
	...
	private JButton buttonCuentasCorrientes;
	private JButton buttonSueldos;	
	private JButton buttonGestionarPersonal;
	...
	public MenuAdministrador(MostrarPanel panel, Persona oPersona) {
		...
		labelMenuAdministrador = new JLabel("Administrador");
		...
		buttonCuentasCorrientes = new JButton("Cuentas Corrientes");
		...
		buttonSueldos = new JButton("Sueldos");
		...
		buttonGestionarPersonal = new JButton("Gestionar Personal");
